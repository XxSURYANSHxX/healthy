...
from services.privacy_profiles import PrivacyProfileError
...
async def root():
    return {
        ...
        "endpoints": {
            ...
            "/api/v1/privacy-profile-demo": "Show safe Week 5 strict vs research privacy profile demo",
...
async def privacy_profile_demo():
    """
    Local Week 5 mentor demo.

    Returns safe synthetic strict/research comparisons without raw PHI, full
    metadata dumps, or file bytes.
    """
    try:
